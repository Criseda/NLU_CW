"""
model.py — RoBERTa-large cross-encoder for Authorship Verification.
...
class AVCrossEncoder(nn.Module):
    """
    RoBERTa-large cross-encoder that takes a concatenated text pair and
    outputs a single logit for binary classification (same-author / different).
