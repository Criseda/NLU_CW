...
% A0 landscape — scale=0.76 fills out the whitespace wonderfully
\usepackage[orientation=landscape,size=a0,scale=0.76]{beamerposter}
    ...
    \begin{exampleblock}{4.\ Sol\,1 — Stylometric Stacking Pipeline}
      ...
      \begin{columns}[c,totalwidth=\linewidth]
        ...
        \begin{column}{0.50\linewidth}
          \begin{center}
            \includegraphics[width=0.85\linewidth]{feature_groups.pdf}\par\vspace*{0.2ex}
...
\begin{columns}[T,totalwidth=\linewidth]
  ...
  \begin{column}{0.32\linewidth}
    \begin{exampleblock}{6.\ Predictive Performance}
      ...
      \vspace{0.2ex}
      \begin{center}
        \includegraphics[width=0.70\linewidth]{performance_comparison.pdf}\par\vspace*{0.2ex}
  ...
  \begin{column}{0.33\linewidth}
    \begin{exampleblock}{7.\ Discussion \& Conclusion}
      ...
      \vspace{0.2ex}
      \begin{center}
        \includegraphics[width=0.38\linewidth]{confusion_matrix.pdf}\par\vspace*{0.2ex}
